...
const SearchBar: React.FC<SearchBarProps> = ({ placeholder = 'Type here...' }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="flex items-center justify-center pt-4 pb-4 border-b border-gray-200 sticky top-0 bg-[#F8F8F8] z-50 px-4">
        {/* Logo at far left */}
        <img
          src={logo}
          alt="logo"
          className="absolute left-4 w-24 h-auto object-contain rounded-md opacity-85 cursor-pointer"
          onClick={() => navigate("/")}
        />
