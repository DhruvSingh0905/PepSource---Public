            ...
            <div className="p-6">
              ...
              <div className="grid gap-4 max-w-md mx-auto">
                <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                  <div className="flex-shrink-0 bg-[#3294b4] text-white w-8 h-8 rounded-full flex items-center justify-center mr-3">
                ...
                <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Access expert analysis of vendor quality and price comparisons, including our constantly expanding database of new vendors.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Stay informed with AI-powered summaries of the latest scientific findings for every compound.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Join our exclusive community of health enthusiasts sharing insights and experiences.
                    </p>
                  </div>
                </div>
              </div>
